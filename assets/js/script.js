...
emailjs.init({
    publicKey: 's0iiWlGSTrmL4pi0e'
  });
  
  document.getElementById("contact-form").addEventListener("submit", function(event) {
      event.preventDefault();
  
      emailjs.sendForm('service_7jwlvjk', 'template_52e27ke', this)
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Youssef";
...
const projects = [
    ...
    },
    {
        ...
        image: "landmarks",
        codeLink: "https://github.com/YoussefMerzouk0/FaceLandmarkDetection"
    },
    {
        ...
        image: "recomendation",
        codeLink: "https://github.com/YoussefMerzouk0/Amzon-Recommendation-Sys"
    }
  ];
